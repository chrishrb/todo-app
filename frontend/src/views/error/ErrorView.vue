    ...
    <main class="w-full max-w-xl mx-auto p-6">
      <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm">
        <div class="grid p-4 sm:p-7 place-items-center">
          ...
          <h1 class="text-xl pb-6 text-red-500 font-bold">Es ist ein unerwarteter Fehler aufgetreten!</h1>
          <p class="text-sm text-gray-800">Bitte kontaktieren Sie die IT, falls der Fehler wiederholt auftritt.</p>
          <button 
