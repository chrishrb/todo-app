<template>
  ...
  <!--   <button type="button" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm" data-hs-overlay="#task-detail-modal"> -->
  <!--     Open modal -->
  <!--   </button> -->
  <!-- </div> -->

  <div id="task-detail-modal" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all lg:max-w-4xl lg:w-full m-3 lg:mx-auto">
      <div class="flex flex-col bg-white border shadow-sm rounded-xl">
        <div class="flex justify-between items-center py-3 px-4 border-b">
          ...
          <button type="button" class="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-sm" data-hs-overlay="#task-detail-modal">
          ...
          <div class="sm:divide-y divide-gray-200">
            <div class="py-3 sm:py-6">
              ...
              <div class="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
                <!-- Card -->
                <a class="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100" href="../docs/frameworks-vuejs.html">
                  <div class="flex">
                    <div class="mt-1.5 flex justify-center flex-shrink-0 rounded-l-xl">
                      <svg class="w-5 h-5 text-gray-800" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <a class="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100" href="../docs/frameworks-vuejs.html">
                  <div class="flex">
                    <div class="mt-1.5 flex justify-center flex-shrink-0 rounded-l-xl">
                      <svg class="w-5 h-5 text-gray-800" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <a class="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100" href="../docs/frameworks-vuejs.html">
                  <div class="flex">
                    ...
                    <div class="grow ml-6">
                      <h3 class="text-sm font-semibold text-blue-600">
                        Mega Menu <span class="ml-1 inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2">Hot</span>
                      </h3>
                      <p class="mt-1 text-sm text-gray-600">
                        A framework for building web user interfaces.
                      </p>
