<template>
  ...
  <Teleport to='#modal'>
    <div class="hs-overlay fixed top-0 left-0 z-[60] justify-center w-full h-full bg-black bg-opacity-10 overflow-x-hidden overflow-y-auto items-center" v-if="isModalOpen">
      ...
      <div ref="modal" class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-1000 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto mt-[10%] flex items-center">
        ...
        <router-view>
          <div class="flex flex-col bg-white border shadow-sm rounded-xl">
            ...
            <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t">
              <button @click="handleDone" type="button" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm">
                Done
              </button>
            </div>
          </div>
