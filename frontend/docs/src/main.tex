...
\newpage
    ...
    beschrieben. Zum Starten und Betreiben (Default Credentials der User, Datenbank-Zugang) der Anwendung sind weitere Informationen in der \it{README.md} des Projekts enthalten.
